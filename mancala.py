...
class Mancala:
    ...
    def return_winner(self):
        """Returns winner if game is over"""
    ...
    def print_board(self):
        """Prints current board information for both players"""
        print(f"player1:\nstore: {self._board[6]}\n{self._board[0:6]}")
    ...
    def p1_play_game(self, pit_index):
        ...
        while shifter < sow:
            ...
            # Lands on opponent's store, skip to next pit
            if idx == 13:       
                idx = 0
                shifter += 1
                sow += 1
            ...
            count -= 1
            # special case 1
            if count == 0 and idx == 6:     
                print("player 1 take another turn")
            # special case 2
            elif count == 0 and idx in [0, 1, 2, 3, 4, 5] and (self._board[idx] - 1 == 0):
    ...
    def p2_play_game(self, pit_index):
        ...
        while shifter < sow:
            ...
            # special case 1
            if count == 0 and idx == 13:
                print("player 2 take another turn")
            # special case 2
            elif count == 0 and idx in [7, 8, 9, 10, 11, 12] and (self._board[idx] - 1 == 0):
